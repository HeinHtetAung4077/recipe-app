    ...
    >
      ...
      <div className="skeleton absolute inset-0" />
        <img
          src={recipe.image}
          alt="recipe img"
          className="w-full h-full rounded-md object-cover cursor-pointer opacity-0 transition-opacity duration-500"
          onLoad={(e) => {
      ...
      <div className="flex gap-2 mt-auto">
        {healthLabels.map((label, idx) => (
          <div
            key={idx}
            className={`flex gap-1 p-1 items-center rounded-md ${badge}`}
          >
            <HeartPulse size={16} />
